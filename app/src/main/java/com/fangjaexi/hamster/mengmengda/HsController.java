package com.fangjaexi.hamster.mengmengda;
 ...
 * 自定义视频控制器
 */
public class HsController extends MediaController {
    ...
    public HsController(Context context, VideoView videoView, Activity activity) {
        super(context);
    ...
    protected View makeControllerView() {
        ...
        //声音控制
        mVolumeBrightnessLayout = (RelativeLayout) v.findViewById(com.fangjaexi.hamster.mvideo.R.id.operation_volume_brightness);
        mOperationBg = (ImageView) v.findViewById(com.fangjaexi.hamster.mvideo.R.id.operation_bg);
        mOperationTv = (TextView) v.findViewById(com.fangjaexi.hamster.mvideo.R.id.operation_tv);
        mOperationTv.setVisibility(View.GONE);
    ...
    private void onVolumeSlide(float percent) {
        ...
        if (index > mMaxVolume)
            ...
            index = 0;
        if (index >= 10) {
            mOperationBg.setImageResource(com.fangjaexi.hamster.mvideo.R.drawable.volmn_100);
        } else if (index >= 5 && index < 10) {
            mOperationBg.setImageResource(com.fangjaexi.hamster.mvideo.R.drawable.volmn_60);
        } else if (index > 0 && index < 5) {
            mOperationBg.setImageResource(com.fangjaexi.hamster.mvideo.R.drawable.volmn_30);
        } else {
            mOperationBg.setImageResource(com.fangjaexi.hamster.mvideo.R.drawable.volmn_no);
        }
    ...
    private void onBrightnessSlide(float percent) {
        ...
        if (lpa.screenBrightness * 100 >= 90) {
            mOperationBg.setImageResource(com.fangjaexi.hamster.mvideo.R.drawable.light_100);
        } else if (lpa.screenBrightness * 100 >= 80 && lpa.screenBrightness * 100 < 90) {
            mOperationBg.setImageResource(com.fangjaexi.hamster.mvideo.R.drawable.light_90);
        } else if (lpa.screenBrightness * 100 >= 70 && lpa.screenBrightness * 100 < 80) {
            mOperationBg.setImageResource(com.fangjaexi.hamster.mvideo.R.drawable.light_80);
        } else if (lpa.screenBrightness * 100 >= 60 && lpa.screenBrightness * 100 < 70) {
            mOperationBg.setImageResource(com.fangjaexi.hamster.mvideo.R.drawable.light_70);
        } else if (lpa.screenBrightness * 100 >= 50 && lpa.screenBrightness * 100 < 60) {
            mOperationBg.setImageResource(com.fangjaexi.hamster.mvideo.R.drawable.light_60);
        } else if (lpa.screenBrightness * 100 >= 40 && lpa.screenBrightness * 100 < 50) {
            mOperationBg.setImageResource(com.fangjaexi.hamster.mvideo.R.drawable.light_50);
        } else if (lpa.screenBrightness * 100 >= 30 && lpa.screenBrightness * 100 < 40) {
            mOperationBg.setImageResource(com.fangjaexi.hamster.mvideo.R.drawable.light_40);
        } else if (lpa.screenBrightness * 100 >= 20 && lpa.screenBrightness * 100 < 20) {
            mOperationBg.setImageResource(com.fangjaexi.hamster.mvideo.R.drawable.light_30);
        } else if (lpa.screenBrightness * 100 >= 10 && lpa.screenBrightness * 100 < 20) {
            mOperationBg.setImageResource(com.fangjaexi.hamster.mvideo.R.drawable.light_20);
        }
